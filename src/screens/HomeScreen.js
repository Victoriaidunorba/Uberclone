     ...
     <ScrollView bounces={false}>
       <View style={styles.home}>
          ...
          <View style={styles.view1}>
            ...
            <View>
              <Image 
                  style = {styles.image1} 
                  source = {require('../../assets/ubercarr.png')}
              />
            </View>
          </View>
       ...
       <View style={styles.view5}>
               <View style={styles.view6}>
                 ...
                 <View>
                 <Text style={{fontSize:18,color:colors.black}}>Agungi Ajiran Rd</Text>
                 <Text style={{color:colors.grey3}}>86, Galleon Close, Erith, Kenth</Text>
                 </View>
                  </View>   
                  <View>
                  <Icon type='material-community'
       ...
       <MapView
                            ...
                            initialRegion = {{...carsAround[0],latitude:6.637200,longitude:3.363520,latitudeDelta:0.008,longitudeDelta:0.008}}
                        >
